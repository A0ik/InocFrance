    ...
    return (
        <div className="min-h-screen bg-background pb-20">
            ...
            <div className="container mx-auto px-4 py-16 max-w-6xl">
                ...
                <div className="flex flex-col md:flex-row gap-12 items-center mb-24">
                    <div className="flex-1">
                        ...
                        <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                            <p>
                                Fondée en 2026, Innocents France est née d'un constat simple : l'aide humanitaire doit être rapide, directe et humaine.
                            </p>
                            <p>
                    ...
                    <div className="flex-1 relative h-[400px] w-full rounded-2xl overflow-hidden shadow-xl">
                        <Image src="https://placehold.co/800x600/1a365d/ffffff?text=Fondateurs" alt="Fondateurs" fill className="object-cover" />
                    </div>
                </div>
                ...
                {/* Gallery */}
                <div>
                    <h2 className="text-3xl font-bold text-primary mb-8 text-center">Nos équipes sur le terrain</h2>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 auto-rows-[200px]">
                        <div className="col-span-2 row-span-2 relative rounded-xl overflow-hidden">
                            <Image src="https://placehold.co/800x800/1a365d/fff?text=Equipe+1" alt="Team 1" fill className="object-cover" />
                        </div>
                        <div className="relative rounded-xl overflow-hidden">
                            <Image src="https://placehold.co/400x400/60a5fa/fff?text=Equipe+2" alt="Team 2" fill className="object-cover" />
                        </div>
                        <div className="relative rounded-xl overflow-hidden">
                            <Image src="https://placehold.co/400x400/999/fff?text=Equipe+3" alt="Team 3" fill className="object-cover" />
                        </div>
                        <div className="col-span-2 relative rounded-xl overflow-hidden">
                            <Image src="https://placehold.co/800x400/222/fff?text=Equipe+4" alt="Team 4" fill className="object-cover" />
                        </div>
                    </div>
                </div>
