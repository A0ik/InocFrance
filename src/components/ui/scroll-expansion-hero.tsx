                                    ...
                                    mediaSrc.includes('youtube.com') ? (
                                        ...
                                        <div className='relative w-full h-full'>
                                            ...
                                            <button
                                                ...
                                                className='absolute bottom-4 right-4 z-50 p-2 bg-black/50 hover:bg-black/70 text-white rounded-full backdrop-blur-sm transition-colors pointer-events-auto'
                                            >
