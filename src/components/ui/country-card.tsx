...
export function CountryCard({ country, image, description }: CountryCardProps) {
    return (
        <motion.div
            ...
            className="relative group overflow-hidden rounded-xl border border-white/10 shadow-lg aspect-[4/3]"
        >
            <Image
                src={image}
                alt={country}
